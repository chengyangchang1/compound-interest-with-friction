...
We substitute it into the above equation to get $I$, which is equal to $207$ dollars. You can look at the [Desmos page](https://www.desmos.com/calculator/aeull6siit) I created, we set $F$ and $V_i$ to the values we want, and then look at the intersection of the two equations, which is the $I$ we are asking for.
